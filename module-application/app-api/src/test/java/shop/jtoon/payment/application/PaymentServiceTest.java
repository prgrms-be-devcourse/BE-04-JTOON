...
class PaymentServiceTest {
    ...
    void validateAndCreatePayment_Amount() {
        // Given
        given(memberDomainService.findByEmail(any(String.class))).willReturn(member);
    ...
    void cancelPayment_Void() {
        ...
        // Then
        verify(iamportService).validateIamport(any(String.class), any(BigDecimal.class));
        verify(iamportService).cancelIamport(any(String.class), any(String.class), any(BigDecimal.class), any(String.class));
    }
